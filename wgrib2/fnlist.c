...
struct function functions[] = {
   ...
   {"geolocation",f_geolocation, inv, 0, "package (proj4,gctpc,internal,not_used) to get lat/lon of grid points", 100},
   ...
   {"ndate",f_ndate, misc, 2, "X=date Y=dt print date + dt", 100},
   {"ndates",f_ndates, misc, 3, "X=date0 Y=(date1|dt1) Z=dt2 for (date=date0; date<(date1|date0+dt1); date+=dt2) print date", 100},
   {"ndates_fmt",f_ndates_fmt, misc, 1, "X = C format for ndates option", 100},
   ...
   {"ens_processing",f_ens_processing, output, 2, "ave/min/max/spread X=output Y=future use", 000},
